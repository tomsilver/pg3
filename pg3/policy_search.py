...
from pg3.structs import LiftedDecisionList, Predicate, STRIPSOperator, Task, \
    Type
from pg3.trajectory_generator import _TrajectoryGenerator
...
def _run_policy_search(
    ...
    # Create a trajectory generator for both the heuristic and search ops.
...
def _create_trajectory_generator() -> _TrajectoryGenerator:
